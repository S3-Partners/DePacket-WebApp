...
export const ExecuteThroughRoleForm = ({
  ...
  const { isRiskConfirmed, setIsRiskIgnored } = txSecurity
  ...
  //   role: role.status === !multiSendImpossible ? role : undefined,
  //   metaTransactions,
  // })
  ...
  const handleSubmit = async (e: SyntheticEvent) => {
    ...
    setFlow(<SuccessScreenFlow txHash={'0x'} />, undefined, false)
    ...
    setFlow(<SuccessScreenFlow txId={''} />, undefined, false)
  }
  ...
  const submitDisabled = isPending || disableSubmit || !isRiskConfirmed
    ...
    <>
      ...
      <form onSubmit={handleSubmit}>
        {!permissionsError && (
          <>
            <Typography sx={{ mb: 2 }}>
              Your <Role>{'role.roleKey'}</Role> role allows you to execute this transaction without the confirmations
              of other owners.
            </Typography>
