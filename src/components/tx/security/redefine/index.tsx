...
const RedefineBlock = () => {
  const { isRiskConfirmed, setIsRiskConfirmed, isRiskIgnored } = useContext(TxSecurityContext)
  ...
  return (
    <div className={css.wrapperBox}>
      <Paper variant="outlined" className={sharedCss.wrapper} sx={{ border: 'none' }}>
        <div>
