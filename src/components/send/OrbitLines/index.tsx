        ...
        */}
        ...
        <defs>
          ...
          >
            ...
            <stop offset="0.331457" stopColor={palette.primary.dark} />
            <stop offset="0.885267" stopColor="#AC2C3B" stopOpacity="0" />
...
const OrbitLine2 = () => {
  return (
    ...
    >
      <svg width="488" height="422" viewBox="0 0 488 422" fill="none">
        {/*
          The "initial" property sets the starting state of the animation:
        ...
        */}
        ...
        <defs>
          ...
          >
            <stop stopColor={palette.primary.main} />
            <stop offset="0.331457" stopColor={palette.primary.dark} />
            <stop offset="0.770581" stopColor="#AC2C3B" stopOpacity="0" />
            <stop offset="1" stopColor={palette.primary.main} stopOpacity="0" />
          </linearGradient>
        </defs>
      </svg>
