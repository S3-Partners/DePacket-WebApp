...
// import { computeNewSafeAddress, createNewSafe, relaySafeCreation } from '@/components/new-packet/create/logic'
// import { getAvailableSaltNonce } from '@/components/new-packet/create/logic/utils'
import NetworkWarning from '@/components/new-packet/create/NetworkWarning'
import css from '@/components/new-packet/create/steps/ReviewStep/styles.module.css'
import layoutCss from '@/components/new-packet/create/styles.module.css'
// import { useEstimateSafeCreationGas } from '@/components/new-packet/create/useEstimateSafeCreationGas'
import useSyncSafeCreationStep from '@/components/new-packet/create/useSyncSafeCreationStep'
import ReviewRow from '@/components/new-packet/ReviewRow'
...
const ReviewStep = ({ data, onSubmit, onBack, setStep }: StepRenderProps<NewPacketFormData>) => {
