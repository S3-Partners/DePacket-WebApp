...
import type { PacketTransaction, Transaction, TransactionOptions, TransactionResult } from '@/types/tx'
...
//   let signedTx: PacketTransaction | undefined
//   try {
...
//     transactionToRelay.data.packetTxGas,
