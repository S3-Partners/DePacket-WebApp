...
import { OperationType, type PacketTransaction } from '@/types/tx'
...
// export const isDelegateCall = (safeTx: PacketTransaction): boolean => {
...
// export const prepareTxExecution = async (safeTransaction: PacketTransaction, provider: Eip1193Provider) => {
