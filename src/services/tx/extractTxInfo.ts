import type { OperationType } from '@/types/tx'
import { type PacketTransactionData } from '@/types/tx'
...
const extractTxInfo = (
  ...
  safeAddress: string,
): { txParams: PacketTransactionData; signatures: Record<string, string> } => {
