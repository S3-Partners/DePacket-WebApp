...
import type { SafeInfo } from '@/types/safeInfo'
import type {
  ChainInfo,
  // SafeAppData
} from '@/types/chains'
...
import type { MetaTransactionData } from '@/types/tx'
import { OperationType } from '@/types/tx'
...
import type { PacketTransaction, TransactionOptions } from '@/types/tx'
...
export const hasEnoughSignatures = (tx: PacketTransaction, safe: SafeInfo) => tx.signatures.size >= safe.threshold
...
// export const decodeSafeTxToBaseTransactions = (safeTx: PacketTransaction): BaseTransaction[] => {
...
export const isRejectionTx = (tx?: PacketTransaction) => {
